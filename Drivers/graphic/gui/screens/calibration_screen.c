 ...
 * =====================================================================================
 *
 *       Filename:  calibration_screen.c
 *
 *    Description:  
 *
 *        Version:  1.0
 *        Created:  23.01.22 23:19:59
 *       Revision:  none
 *       Compiler:  gcc
 *
 *         Author:  YOUR NAME (), 
...
static void setCalState(state_t s) {
	...
	if(current_state != cal_end) {
		...
		sprintf(waitStr, "Set. temp.to\n%dC", state_temps[(int)s]);
...
void calibration_screen_setup(screen_t *scr) {
	...
	screen_t *sc = lcd_addScreen(screen_edit_calibration_input);
